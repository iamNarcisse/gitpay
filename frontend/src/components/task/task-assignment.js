...
const TaskAssignment = (props) => {
    ...
    if (props.taskFundingDialog) {
      return (
        <Grid
          container
          spacing={ 24 }
          style={ { fontFamily: 'Roboto', color: '#a9a9a9' } }
        >
    ...
    if (props.taskFundingDialog) {
      return (
        <DialogActions>
          ...
          >
            <FormattedMessage
              id='task.bounties.actions.cancel'
    ...
    if (props.assignDialog) {
      return (
        <DialogActions>
          ...
          >
            <FormattedMessage
              id='task.bounties.actions.work'
              defaultMessage='I want to work on this issue'
            />
          </Button>
        </DialogActions>
      )
        ...
        <React.Fragment>
          ...
          >
            ...
            >
              ...
              >
                <FormattedMessage
                  id='task.bounties.interested.question'
                  defaultMessage='Are you interested to solve this task?'
                />
              </Typography>
            </DialogTitle>
          </div>
            ...
            <Grid item xs={ 11 } md={ 7 }>
              <Typography type='caption' gutterBottom style={ { color: 'gray' } }>
                <FormattedMessage
                  ...
                  defaultMessage={
                    'Please apply only if you\'re able to do it and if you\'re available and commited to finish in the deadline.'
                  }
                >
  ...
  const imageCover = () => {
    if (props.assignDialog) {
      return <img src={ props.taskCover } className={ classes.taskCoverImg } />
    }

    if (props.taskFundingDialog) {
      return <img src={ props.inviteCover } className={ classes.taskCoverImg } />
    }
  }
  ...
  return (
    <Dialog
      ...
      onClose={
        props.handleAssignFundingDialogClose ||
        props.handleAssignFundingDialogClose
      }
      ...
      { !props.logged ? (
        ...
        <div>
          ...
          <form
            onSubmit={
              props.assignDialog
                ? props.handleAssignTask
                : props.sendFundingInvite
            }
          >
            <DialogContent>
              { emailInviteInput() }
              ...
              >
                ...
                >
                  ...
                  <div style={ { paddingLeft: 5 } }>
                    ...
                    >
                      ...
                      >
                        { (msg) => (
                          <span className={ classes.spanText }>{ msg }</span>
                        ) }
                      </FormattedMessage>
                    </Typography>
                  </div>
                ...
                { props.showSuggestAnotherDateField && (
                  <FormControl fullWidth>
                    <FormattedMessage
                      id='task.status.deadline.day.label'
                      defaultMessage='Day'
                    >
                      { (msg) => (
              ...
              <div style={ { textAlign: 'center' } }>
                ...
                >
                  <FormattedMessage
                    id='task.bounties.interested.canSuggestBounty'
                    defaultMessage='Suggest a bounty'
                  />
                </Typography>
              </div>
              ...
              >
                <InputLabel htmlFor='interested-amount'>
                  <FormattedMessage
                    id='task.bounties.interested.amount.value'
          ...
          >
            ...
            <DialogActions>
              <Button
                onClick={ () => props.handleTermsDialogClose(false) }
                color='primary'
              >
                <FormattedMessage
